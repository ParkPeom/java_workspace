...
//UCP(Universal Connection ppol)(어디서나 쓸수있는 커넥션풀) 라이브러리의 DBCP 관련 클래스를 이용한 JDBC  프로그램 
public class DataSourceApp {
	public static void main(String[] args) throws SQLException {
		// PoolDataSource : DBCP 기능을 제공하기 위한 인스턴스 
		// DataSource pds = PoolDataSourceFactory.getPoolDataSource(); 
		
		// ucp에서 PoolDataSource 인터페이스 사용 
		...
		pds.setMaxPoolSize(3); // 최대 생성 가능한 Connection 인스턴스의 갯수 변경 , 0 : 제한이없다
